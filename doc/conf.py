...
# sphinx-quickstart on Mon Oct  3 16:27:16 2016.
#
...
project = 'Project Cage'
copyright = '2016, THaGKI9'
author = 'THaGKI9'
...
#
html_title = 'API Document for Project Cage'
...
for key, value in Config.__dict__.items():
    ...
    rst_epilog.append('.. |%s| replace:: %s' % (key, value))
